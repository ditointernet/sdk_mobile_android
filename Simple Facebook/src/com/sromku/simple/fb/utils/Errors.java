...
public class Errors {
    public static enum ErrorMsg {
        LOGIN("You are not logged in"), PERMISSIONS_PUBLISH("Publish permission: '%s' wasn't set by SimpleFacebookConfiguration"), CANCEL_PERMISSIONS_PUBLISH("Publish permissions: '%s' weren't accepted by user");
